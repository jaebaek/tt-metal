        ...
        if constexpr (zero_srcA) {
            if (num_faces == 4) {
                if (n == 0) {
                    ...
                    ckernel::ckernel_template::run(instrn_buffer);
                    TTI_UNPACR_NOP(SrcA, 0, 0, 0, 0b1 /*unpack_nop + dvalid*/, 0, 0, 0, p_unpacr_nop::UNP_ZEROSRC);
                    TTI_UNPACR_NOP(SrcB, 0, 0, 0, 0b1 /*unpack_nop + dvalid*/, 0, 0, 0, p_unpacr_nop::UNP_ZEROSRC);
