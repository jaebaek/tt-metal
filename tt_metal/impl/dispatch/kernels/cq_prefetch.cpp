...
constexpr uint32_t dispatch_h_exec_buf_sem_id = get_compile_time_arg_val(21);

constexpr uint32_t is_d_variant = get_compile_time_arg_val(22);
constexpr uint32_t is_h_variant = get_compile_time_arg_val(23);
