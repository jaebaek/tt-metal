...
class Algorithm {
   ...
   public:
    ...
    void init() { static_cast<AllocatorType *>(this)->init(); }
    ...
    void deallocate(uint64_t absolute_address) { static_cast<AllocatorType *>(this)->deallocate(absolute_address); }

    void clear() { static_cast<AllocatorType *>(this)->clear(); }

    Statistics get_statistics() const { return static_cast<AllocatorType *>(this)->get_statistics(); }

    void dump_blocks(std::ofstream &out) const { static_cast<AllocatorType *>(this)->dump_block(); }
