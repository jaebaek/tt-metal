...
class TtMobilenetv2:
    ...
    def __call__(self, device, input_tensor):
        ...
        output_tensor_a4 = tt_lib.tensor.sharded_to_interleaved(
            output_tensor,
            output_mem_config=tt_lib.tensor.MemoryConfig(
                tt_lib.tensor.TensorMemoryLayout.INTERLEAVED, tt_lib.tensor.BufferType.L1
            ),
        ...
        output_tensor_a5 = tt_lib.tensor.interleaved_to_sharded(
            output_tensor_a5, sharded_mem_config=output_tensor_c21.memory_config()
        )
        output_tensor = tt_lib.tensor.sharded_to_interleaved(
            output_tensor,
            output_mem_config=tt_lib.tensor.MemoryConfig(
