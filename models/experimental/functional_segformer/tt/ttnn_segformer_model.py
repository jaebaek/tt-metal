...
import ttnn
from models.experimental.functional_segformer.tt.ttnn_segformer_encoder import ttnn_SegformerEncoder
...
class ttnn_SegformerModel:
    def __init__(self, config, parameters, model):
        super().__init__()
        self.config = config

        # hierarchical Transformer encoder
        self.encoder = ttnn_SegformerEncoder(config, parameters.encoder, model.encoder)
