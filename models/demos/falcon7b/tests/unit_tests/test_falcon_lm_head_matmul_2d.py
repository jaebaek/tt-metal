...
from models.demos.falcon7b.tt.model_utils import falcon_lm_head_matmul_2d
...
def run_falcon_lm_head_matmul_2d(
    ...
    for i in range(num_slices):
        b_t_slices.append(
            ttl.tensor.Tensor(B_slices[i], in1_dtype).to(ttl.tensor.Layout.TILE).to(device, in1_mem_config)
        )
