...
def test_embedding_bw_with_opt_out(input_shapes, device, are_required_outputs):
    ...
    tt_output_tensor_on_device = tt_lib.tensor.embedding_bw(
        grad_tensor, input_tensor, weights_tensor, are_required_outputs=are_required_outputs, input_grad=input_grad
    )
    weights.retain_grad()
