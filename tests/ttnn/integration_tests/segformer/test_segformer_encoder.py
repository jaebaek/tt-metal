...
def test_segformer_encoder(batch_size, num_channels, height, width, device, reset_seeds):
    ...
    ttnn_model = ttnn_SegformerEncoder(config, parameters, reference_model)
    ...
    assert_with_pcc(torch_output.last_hidden_state, ttnn_final_output, pcc=0.99)
