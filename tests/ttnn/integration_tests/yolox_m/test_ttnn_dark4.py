...
def test_dark4(device, reset_seeds, model_location_generator):
    ...
    torch_input_tensor = torch.randn(1, 192, 80, 80)  # Batch size of 1, 128 input channels, 160x160 height and width
    ...
    assert_with_pcc(torch_output_tensor, output_tensor, pcc=0.99)  # PCC = 0.9824520887645896
