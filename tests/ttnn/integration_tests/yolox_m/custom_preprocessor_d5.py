...
def custom_preprocessor(device, model, name, ttnn_module_args):
    ...
    if isinstance(model, Dark5):
        ...
        # ttnn_module_args.c4["use_1d_systolic_array"] = ttnn_module_args.c4.in_channels < 256
        ...
        # ttnn_module_args.c5["use_1d_systolic_array"] = True
