...
namespace tt::tt_metal::detail{
    ...
    m_tensor.def("addcmul_bw", &tt::tt_metal::addcmul_bw,
            py::arg("grad").noconvert(), py::arg("input").noconvert(), py::arg("tensor1").noconvert(), py::arg("tensor2").noconvert(), py::arg("value") = 1.0f, py::arg("output_mem_config").noconvert() = operation::DEFAULT_OUTPUT_MEMORY_CONFIG, py::arg("are_required_outputs").noconvert() = std::vector<bool>{true, true, true}, py::arg("input_grad").noconvert() = std::nullopt, py::arg("tensor1_grad").noconvert() = std::nullopt, py::arg("tensor2_grad").noconvert() = std::nullopt, R"doc(
