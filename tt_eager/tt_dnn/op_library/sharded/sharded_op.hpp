...
struct Sharded {
    ...
    static constexpr auto attribute_names =
        std::forward_as_tuple("grid_size", "sharded_op_type", "output_mem_config", "output_dtype");
    const auto attribute_values() const {
        return std::forward_as_tuple(
            this->grid_size, this->sharded_op_type, this->output_mem_config, this->output_dtype);
    }
};
