...
Tensor eqi(
    ...
    Tensor& input_b,
    MemoryConfig& output_mem_config) {
    return operation::decorate_as_composite(__func__, _eqi)(input_a, input_b, output_mem_config);
    }

Tensor _eqi_overload(
    Tensor& input_a,
    float value,
    MemoryConfig& output_mem_config) {
...
Tensor eqi(
    ...
    float value,
    MemoryConfig& output_mem_config) {
    return operation::decorate_as_composite(__func__, _eqi_overload)(input_a, value, output_mem_config);
    }
